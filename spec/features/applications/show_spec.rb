...
it "can see application info" do
 ...
 it "can see application approve button" do # User Story 22
  shelter_1 = Shelter.create( name: "Drew's Rescue",
                              address: "208 Main St.",
                              city: "Denver",
                              state: "CO",
  ...
  application.pets << jasper
   ...
   expect(page).to have_content("On hold for Brett")
 end

 it "can see application approve button" do # User Story 23
   shelter_1 = Shelter.create( name: "Drew's Rescue",
                             address: "208 Main St.",
                             city: "Denver",
                             state: "CO",
